// 형 변환 : 어떤 값의 타입을 다른 타입으로 변경하는 것 ( 묵시적 형 변환, 명시적 형 변환 )
...
console.log(result); // 1020 (숫자 + 문자열 = 문자열)
...
console.log(10 + strToNum1); // 20 (문자열을 숫자로 형변환한 수, 숫자와 숫자끼리 합 = 숫자)
...
// 단, 숫자가 앞에 있는 경우만 해당. 문자가 앞에 있는 경우는 NaN 출력됨
